...
long twitchLEDTime[HPCOUNT] = {3800, 3900, 4000}; //LEDS Start up ~4 seconds after boot  Use Unique values for each
long twitchHPTime[HPCOUNT]  = {4000, 4000, 4000}; //HPs Start 4 seconds after boot
long twitchLEDRunTime[HPCOUNT];

long LEDHaltTime[HPCOUNT];
long HPHaltTime[HPCOUNT];
